    ...
    return function (createFFmpegCore) {
        ...
        var Fe = {
                            ...
                            if (35716 == b)
                                ...
                                if (-1 == d.kg)
                                    for (
                                        ...
                                        d.kg = Math.max(
                                            d.kg,
                                            V.getActiveUniformBlockName(a, b)
                                                .length + 1
                                        );
                                E[c >> 2] = d.kg;
            ...
            n: function (a, b, c, d) {
                ...
                if (!a)
                    return (
                        u('pthread_create called with a null thread pointer!'),
                        28
                    );
                var e = [];
            ...
            m: function (a, b, c, d) {
                ...
                q = {
                    ...
                    '%z': function (p) {
                        ...
                        return (
                            (x ? '+' : '-') +
                            String('0000' + ((p / 60) * 100 + (p % 60))).slice(
                                -4
                            )
                        );
                    },
